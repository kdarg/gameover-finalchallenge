...
<div align="center">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:verdana,geneva;"><tr><td style="font-family:verdana,geneva;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${process.env.BACKEND_URL}/api/verify/${uniqueString}" style="height:44px; v-text-anchor:middle; width:136px;" arcsize="32%" strokecolor="#d9f9ff" strokeweight="3px" fillcolor="#00c3f6"><w:anchorlock/><center style="color:#FFFFFF;font-family:verdana,geneva;"><![endif]-->
    <a href="${process.env.BACKEND_URL}/api/verify/${uniqueString}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:verdana,geneva;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #00c3f6; border-radius: 14px;-webkit-border-radius: 14px; -moz-border-radius: 14px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-width: 3px; border-top-style: solid; border-top-color: #d9f9ff; border-left-width: 3px; border-left-style: solid; border-left-color: #d9f9ff; border-right-width: 3px; border-right-style: solid; border-right-color: #d9f9ff; border-bottom-width: 3px; border-bottom-style: solid; border-bottom-color: #d9f9ff;">
