  ...
  return (
    <nav className="nav">
      <div className='logo-title'>
        ...
        <a class="navbar-brand title-web container" href="#">GAME OVER</a>
      </div>
